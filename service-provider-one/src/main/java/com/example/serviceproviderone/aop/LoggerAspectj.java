package com.example.serviceproviderone.aop;
...
//    private static final Logger LOGGER = LoggerFactory.getLogger("AppAspect");
   ...
   @Pointcut("execution(* com.example.serviceproviderone.controller.*.*(..))")
...
//     * @return
//     */
//    @Around(value = "execution(* com.example.serviceproviderone.controller.*.*(..))")
...
//    }
//
//    @AfterThrowing(pointcut = "execution(* com.example.serviceproviderone.controller.*.*(..))", throwing = "ex")
//    public void onExceptionThrow(Exception ex) {
//        LOGGER.info("",ex);
//    }
